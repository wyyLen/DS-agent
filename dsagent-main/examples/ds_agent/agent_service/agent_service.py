...
def _import_metagpt():
    ...
    if DSAgentStream is None:
        from dsagent_core.roles.ds_agent_stream import DSAgentStream as _DSAgentStream
        from dsagent_core.roles.lats_react_stream import LanguageAgentTreeSearchStream as _LATS
