...
AGENT_SERVICE_FILE = METAGPT_ROOT / "DSassistant" / "uploads"
EXP_PLAN = EXAMPLE_DATA_PATH / "exp_bank" / "plan_exp.json"
WORKFLOW_EXP = EXAMPLE_DATA_PATH / "exp_bank" / "workflow_exp2_clean.json"
CUSTOM_DA_EVAL_RES_FILE = EXAMPLE_DATA_PATH / "exp_bank" / "custom_da_eval_res.json"
DI_EVAL_RES_FILE = EXAMPLE_DATA_PATH / "exp_bank" / "di_eval_res.json"
DA_EVAL_RES_PATH = EXAMPLE_DATA_PATH / "exp_bank"
