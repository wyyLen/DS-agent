...
# Import specific embeddings lazily in their respective methods to avoid
# dependency errors when only using a subset of embedding providers
...
class RAGEmbeddingFactory(GenericFactory):
    ...
    def __init__(self, config: Optional[Config] = None):
        creators = {
            ...
            EmbeddingType.DASHSCOPE: self._create_dashscope,
    ...
    def _create_dashscope(self) -> "DashScopeEmbedding":
        ...
        return DashScopeEmbedding(**params)
